...
* Review the [User Guide](https://docs.webrcade.com/userguide/) to familiarize yourself with the webЯcade front-end.
...
* Review the documentation for each [Application](https://docs.webrcade.com/apps/) that is launched to determine its keyboard and gamepad mappings as well as any other application-specific notes.
...
The [default feed AUTHORS page](https://github.com/webrcade/webrcade-default-feed/blob/main/AUTHORS-default-feed.md) includes the list of titles included in the default feed, their respective authors, and related links.
...
webЯcade is free and open-source, and will always remain so. If you enjoy the project and would like to help cover some of the ongoing costs (GitHub, hosting, domain, etc.), contributions are greatly appreciated but never expected.

<p>
  <a href="https://buymeacoffee.com/webrcade"><img src="https://img.shields.io/badge/Buy%20Me%20a%20Coffee-ffdd00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" alt="Buy Me a Coffee"></a>
  &nbsp;
